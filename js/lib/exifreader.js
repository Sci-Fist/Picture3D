!(function (e, t) {
  ...
  return (function () {
    ...
    function v(e, t, n) {
      ...
      return void 0 !== t
        ? Promise.reject("Unknown compression method ".concat(t, "."))
        : e;
    }
    var h = {
      USE_FILE: 1,
    ...
    var I = 18761,
      ...
      Q = "JFIF",
      ee = "Exif",
      te = "http://ns.adobe.com/xap/1.0/\0",
      ne = "http://ns.adobe.com/xmp/extension/\0",
      re = "Photoshop 3.0";
    function ie(e, t) {
    ...
    function de(e, t) {
      return { dataOffset: e + F, length: t - (F - x) };
    }
    function pe(e, t) {
      return { dataOffset: e + R, length: t - (R - x) };
    }
    function me(e, t) {
      var n = re.length;
      return (
    ...
    function ke(e, t) {
      return a(e, t + Ie, Se) === Te;
    }
    function De(e, t) {
      return a(e, t + Ie, Se) === Oe;
    }
    function Ne(e, t) {
      var n = [we, xe],
        r = a(e, t + Ie, Se);
          ...
          : 1768714083 === o
            ...
            : 1768517222 === o
              ? (function (e, t, n, r, i) {
                  ...
                  return {
                    type: "iinf",
                    itemInfos: Ke(e, a.itemInfos, i - (a.itemInfos - t)),
                    length: i,
                  };
                })(e, t, c, i + 1, r)
              : 1768842853 === o
                ? (function (e, t, n, r, i) {
                    ...
                    return (
                      ...
                      n >= 2 &&
                        (2 === n
                          ? ((o.itemId = e.getUint16(r)), (r += 2))
                          : 3 === n && ((o.itemId = e.getUint32(r)), (r += 4)),
                        (o.itemProtectionIndex = e.getUint16(r)),
                        (r += 2),
                        ...
                        o.itemType === He
                          ? ((o.contentType = u(e, r)),
                            t + i > (r += o.contentType.length + 1) &&
                              ((o.contentEncoding = u(e, r)),
                              (r += o.contentEncoding.length + 1)))
                          : 1970432288 === o.itemType &&
                            ((o.itemUri = u(e, r)),
                            (r += o.itemUri.length + 1))),
                      o
                    );
                  })(e, t, c, i + 1, r)
                : { type: void 0, length: r };
      }
    }
    function Xe(e) {
                  ...
                  var t = (function (e) {
                      return e.subBoxes
                        ...
                        .itemInfos.find(function (e) {
                          return (
                            e.itemType === He &&
                            "application/rdf+xml" === e.contentType
                          );
                        });
                    })(e).itemId,
                    n = Je(e, t),
    ...
    function Ke(e, t, n) {
      for (var r = [Ve, He], i = [], o = t; o < t + n; ) {
        ...
        if (void 0 === a) break;
        void 0 === a.type ||
          (void 0 !== a.itemType && -1 === r.indexOf(a.itemType)) ||
          i.push(a),
          (o += a.length);
      }
      return i;
      ...
      et = {
        parseAppMarkers: function (e, t) {
          if (
            ...
            return tt(
              h.USE_EXIF ? { hasAppMarkers: 1, tiffHeaderOffset: 0 } : {},
              "tiff",
              "TIFF",
            );
          if (
            ...
            return tt(
              (function (e) {
                for (
                  var t, n, r, i, o, a, u, c, f, s = E;
                  s + w + 5 <= e.byteLength;

                ) {
                  if (h.USE_FILE && ie(e, s))
                    (t = e.getUint16(s + x)), (n = s + x);
                  else if (h.USE_FILE && oe(e, s))
                    (t = e.getUint16(s + x)), (r = s + x);
                  else if (h.USE_JFIF && ce(e, s))
                    (t = e.getUint16(s + x)), (i = s + T);
                  else if (h.USE_EXIF && fe(e, s))
                    (t = e.getUint16(s + x)), (o = s + O);
                  else if (h.USE_XMP && se(e, s))
                    u || (u = []), (t = e.getUint16(s + x)), u.push(de(s, t));
                  else if (h.USE_XMP && le(e, s))
                    u || (u = []), (t = e.getUint16(s + x)), u.push(pe(s, t));
                  else if (h.USE_IPTC && me(e, s))
                    (t = e.getUint16(s + x)), (a = s + M);
                  else if (h.USE_ICC && ae(e, s)) {
                    t = e.getUint16(s + x);
                    var l = s + k,
                      d = t - (k - x),
                      p = e.getUint8(s + L),
                  ...
                  } else if (h.USE_MPF && ue(e, s))
                    (t = e.getUint16(s + x)), (f = s + D);
                  else {
                    if (!ge(e, s)) {
                      if (ve(e, s)) {
                        s++;
          ...
          if (
            h.USE_PNG &&
            (function (e) {
              return !!e && a(e, 0, he.length) === he;
            })(e)
          )
            return tt(
              (function (e, t) {
                for (
                  var n = { hasAppMarkers: 0 }, r = he.length;
                  r + ye + Se <= e.byteLength;

                ) {
                  if (h.USE_PNG_FILE && Me(e, r))
                    (n.hasAppMarkers = 1), (n.pngHeaderOffset = r + Ce);
                  else if (h.USE_XMP && Fe(e, r)) {
                    var i = Le(e, r);
                    void 0 !== i &&
                      ((n.hasAppMarkers = 1),
                      (n.xmpChunks = [
                    ...
                    (n.hasAppMarkers = 1), (n.tiffHeaderOffset = r + Ce);
                  else if (h.USE_ICC && t && De(e, r)) {
                    n.hasAppMarkers = 1;
                    var u = e.getUint32(r + be),
                      c = r + Ce,
                      f = _e(e, c),
                      s = f.profileName,
            ...
            return tt(
              (function (e) {
                for (var t, n, r, i, o = 12, u = 0; o + 8 < e.byteLength; ) {
                  ...
                  h.USE_EXIF && "EXIF" === c
                    ? ((u = 1),
                      (t = "Exif\0\0" === a(e, o + 8, 6) ? o + 8 + 6 : o + 8))
                    : h.USE_XMP && "XMP " === c
                      ? ((u = 1), (n = [{ dataOffset: o + 8, length: f }]))
                      : h.USE_ICC && "ICCP" === c
                        ? ((u = 1),
                          (r = [
                            {
          ...
          if (
            ...
            return tt({ gifHeaderOffset: 0 }, "gif", "GIF");
          if (
            h.USE_XMP &&
            (function (e) {
              return !!e && a(e, Ze, Qe.length) === Qe;
            })(e)
          )
            return tt(
              (function (e) {
                var t = [];
                return (
                  t.push({ dataOffset: Ze, length: e.byteLength }),
                  { xmpChunks: t }
                );
              })(e),
              "xml",
    ...
    var nt = {
        ...
        ShutterSpeedValue: function (e) {
          ...
          return t <= 1
            ? "".concat(Math.round(1 / t))
            : "1/".concat(Math.round(t));
        },
    ...
    var dt = l({}, rt, {
        ...
        37121: {
          ...
          description: nt.ComponentsConfiguration,
        },
        ...
        41488: {
          ...
          description: nt.FocalPlaneResolutionUnit,
        },
        41492: {
      ...
      yt = lt(
        lt(
          lt(
            lt(
              lt(lt(lt(lt({}, pt, dt), "1st", rt), mt, dt), "gps", ut),
              gt,
              ct,
            ),
            "mpf",
      ...
      St = { 1: 1, 2: 1, 3: 2, 4: 4, 5: 8, 7: 1, 9: 4, 10: 8, 13: 4 },
      bt = {
        BYTE: 1,
        ASCII: 2,
        SHORT: 3,
      ...
      It = {
        ...
        getTypeSize: function (e) {
          if (void 0 === bt[e]) throw Error("No such type found.");
          return St[bt[e]];
        },
      };
    function Ct(e, t) {
    ...
    var At = {
      ...
      7: It.getUndefinedAt,
      9: It.getSlongAt,
      10: It.getSrationalAt,
      13: It.getIfdPointerAt,
    };
    function Et(e, t, n) {
      return t + It.getLongAt(e, t + 4, n);
    }
    function wt(e, t, n, r, i, o) {
      var a = It.getTypeSize("SHORT"),
        u = {},
        c = (function (e, t, n) {
          return t + It.getTypeSize("SHORT") <= e.byteLength
            ? It.getShortAt(e, t, n)
            : 0;
        })(e, r, i);
      r += a;
      for (var f = 0; f < c && !(r + 12 > e.byteLength); f++) {
        var s = xt(e, t, n, r, i, o);
        void 0 !== s &&
          ((u[s.name] = {
            id: s.id,
            value: s.value,
          ...
          ("MakerNote" === s.name || (t === ht && "LevelInfo" === s.name)) &&
            (u[s.name].__offset = s.__offset)),
          (r += 12);
      }
      if (h.USE_THUMBNAIL && r < e.byteLength - It.getTypeSize("LONG")) {
        var l = It.getLongAt(e, r, i);
        0 !== l && t === pt && (u.Thumbnail = wt(e, "1st", n, n + l, i, o));
      }
      return u;
    }
    function xt(e, t, n, r, i, o) {
      var a,
        u,
        c = It.getTypeSize("SHORT"),
        f = c + It.getTypeSize("SHORT"),
        s = f + It.getTypeSize("LONG"),
        l = It.getShortAt(e, r, i),
        d = It.getShortAt(e, r + c, i),
        p = It.getLongAt(e, r + f, i);
      if (void 0 !== It.typeSizes[d] && (o || void 0 !== yt[t][l])) {
        (a = (function (e, t) {
          return It.typeSizes[e] * t <= It.getTypeSize("LONG");
        })(d, p)
          ? Tt(e, (u = r + s), d, p, i)
          : (function (e, t, n, r, i) {
                return t + n + It.typeSizes[r] * i <= e.byteLength;
              })(e, n, (u = It.getLongAt(e, r + s, i)), d, p)
            ? Tt(e, n + u, d, p, i, 33723 === l)
            : "<faulty value>"),
          d === It.tagTypes.ASCII &&
            (a = (function (e) {
              try {
        ...
        var m = "undefined-".concat(l),
          g = a;
        if (void 0 !== yt[t][l])
          if (void 0 !== yt[t][l].name && void 0 !== yt[t][l].description) {
            m = yt[t][l].name;
            try {
              g = yt[t][l].description(a);
            } catch (e) {
              g = Ot(a);
            }
          } else
            d === It.tagTypes.RATIONAL || d === It.tagTypes.SRATIONAL
              ? ((m = yt[t][l]), (g = "" + a[0] / a[1]))
              : ((m = yt[t][l]), (g = Ot(a)));
    ...
    function Tt(e, t, n, r, i) {
      ...
      arguments.length > 5 &&
        void 0 !== arguments[5] &&
        arguments[5] &&
        ((r *= It.typeSizes[n]), (n = It.tagTypes.BYTE));
      for (var a = 0; a < r; a++)
        o.push(At[n](e, t, i)), (t += It.typeSizes[n]);
      return (
        n === It.tagTypes.ASCII
          ? (o = It.getAsciiValue(o))
          : 1 === o.length && (o = o[0]),
        o
      );
    }
    ...
    var Mt = "Exif IFD Pointer",
      Ft = "GPS Info IFD Pointer",
      Rt = "Interoperability IFD Pointer",
      kt = {
        read: function (e, t, n) {
          var r = U(e, t),
            i = (function (e, t, n, r) {
              return wt(e, pt, t, Et(e, t, n), n, r);
            })(e, t, r, n);
          return {
            tags: (i = Lt(
              (i = Nt((i = Dt(i, e, t, r, n)), e, t, r, n)),
              e,
              t,
              r,
              n,
    ...
    function Dt(e, t, n, r, i) {
      return void 0 !== e[Mt] ? l(e, wt(t, mt, n, n + e[Mt].value, r, i)) : e;
    }
    function Nt(e, t, n, r, i) {
      return void 0 !== e[Ft]
        ? l(e, wt(t, "gps", n, n + e[Ft].value, r, i))
        : e;
    }
    function Lt(e, t, n, r, i) {
      return void 0 !== e[Rt] ? l(e, wt(t, gt, n, n + e[Rt].value, r, i)) : e;
    }
    var _t = {
        read: function (e, t, n) {
          var r = U(e, t);
          return (function (e, t, n, r) {
            ...
            for (
              var i = [], o = 0;
              o < Math.ceil(n.MPEntry.value.length / Bt);
              o++
            ) {
              i[o] = {};
              var a = Gt(n.MPEntry.value, o * Bt, It.getTypeSize("LONG"), r);
              (i[o].ImageFlags = jt(a)),
                (i[o].ImageFormat = zt(a)),
                (i[o].ImageType = Vt(a));
              var u = Gt(
                n.MPEntry.value,
                o * Bt + 4,
              ...
              var c = Ht(o, n.MPEntry, r, t);
              i[o].ImageOffset = { value: c, description: "" + c };
              var f = Gt(
                n.MPEntry.value,
                o * Bt + 12,
                It.getTypeSize("SHORT"),
                r,
              );
              ...
              (i[o].DependentImage2EntryNumber = {
                ...
                d(i[o], "base64", function () {
                  return p(this.image);
                });
            }
            return (n.Images = i), n;
          })(e, t, wt(e, "mpf", t, Et(e, t, r), r, n), r);
        },
      },
      Bt = 16;
    function Gt(e, t, n, r) {
    ...
    function Ht(e, t, n, r) {
      return (function (e) {
        ...
        ? 0
        : Gt(t.value, e * Bt + 8, It.getTypeSize("LONG"), n) + r;
    }
    var Wt = {
      read: function (e, t) {
        var n = (function (e, t) {
            return It.getShortAt(e, t);
          })(e, t),
          r = (function (e, t, n) {
            if (!(8 > n)) {
              var r = It.getByteAt(e, t + 7);
              return { value: r, description: "" + r };
            }
          })(e, t, n);
        return {
          "Bits Per Sample": Xt(e, t, n),
          "Image Height": Jt(e, t, n),
          "Image Width": Yt(e, t, n),
          "Color Components": r,
          Subsampling: r && Kt(e, t, r.value, n),
        };
      },
    };
    function Xt(e, t, n) {
      if (!(3 > n)) {
        var r = It.getByteAt(e, t + 2);
        return { value: r, description: "" + r };
      }
    }
    function Jt(e, t, n) {
      if (!(5 > n)) {
        var r = It.getShortAt(e, t + 3);
        return { value: r, description: "".concat(r, "px") };
      }
    }
    function Yt(e, t, n) {
      if (!(7 > n)) {
        var r = It.getShortAt(e, t + 5);
        return { value: r, description: "".concat(r, "px") };
      }
    }
    function Kt(e, t, n, r) {
      if (!(8 + 3 * n > r)) {
        ...
        return { value: i, description: i.length > 1 ? qt(i) + $t(i) : "" };
      }
    }
    function qt(e) {
    ...
    var Zt = {
      read: function (e, t) {
        var n = (function (e, t) {
          ...
          r = (function (e, t, n) {
            if (!(15 > n)) {
              var r = It.getByteAt(e, t + 14);
              return { value: r, description: "".concat(r, "px") };
            }
          })(e, t, n),
          i = (function (e, t, n) {
            if (!(16 > n)) {
              var r = It.getByteAt(e, t + 15);
              return { value: r, description: "".concat(r, "px") };
            }
          })(e, t, n),
          o = {
            "JFIF Version": Qt(e, t, n),
            "Resolution Unit": en(e, t, n),
            XResolution: nn(e, t, n),
            YResolution: rn(e, t, n),
    ...
    function Qt(e, t, n) {
      if (!(9 > n)) {
        var r = It.getByteAt(e, t + 7),
          i = It.getByteAt(e, t + 7 + 1);
        return { value: 256 * r + i, description: r + "." + i };
      }
    }
    function en(e, t, n) {
      if (!(10 > n)) {
        var r = It.getByteAt(e, t + 9);
        return { value: r, description: tn(r) };
      }
    }
    function tn(e) {
    ...
    function nn(e, t, n) {
      if (!(12 > n)) {
        var r = It.getShortAt(e, t + 10);
        return { value: r, description: "" + r };
      }
    }
    function rn(e, t, n) {
      if (!(14 > n)) {
        var r = It.getShortAt(e, t + 12);
        return { value: r, description: "" + r };
      }
    }
    var on = {
      iptc: {
        ...
        326: { name: "Date Sent", description: an },
        336: { name: "Time Sent", description: un },
        346: {
        ...
        567: { name: "Date Created", description: an },
        572: { name: "Time Created", description: un },
        574: { name: "Digital Creation Date", description: an },
        575: { name: "Digital Creation Time", description: un },
          ...
          try {
            ...
            var r = (function (e, t) {
              for (; t + 12 <= e.byteLength; ) {
                var n = ln(e, t);
                if (dn(n)) return { naaBlock: n, dataOffset: t + n.headerSize };
                t += n.headerSize + n.size + pn(n);
              }
              throw Error("No IPTC NAA resource block.");
            })(e, t);
            return mn(e, r.naaBlock, r.dataOffset, n);
          } catch (e) {
            return {};
          }
        },
    ...
    function gn(e, t, n, r, i) {
      ...
      var o = e.getUint16(t + 1),
        a = e.getUint16(t + 3);
      if (!i && !on.iptc[o]) return { tag: void 0, tagSize: a };
      var u = (function (e, t, n) {
        ...
        c = {
          id: o,
          name: vn(on.iptc[o], o, u),
          value: u,
          description: hn(on.iptc[o], u, n, r),
        };
      return (
        (function (e) {
          return on.iptc[e] && on.iptc[e].repeatable;
        })(o) && (c.repeatable = 1),
        (function (e) {
          return on.iptc[e] && void 0 !== on.iptc[e].encoding_name;
        })(o) && (c.encoding = on.iptc[o].encoding_name(u)),
        { tag: c, tagSize: a }
      );
    }
    function vn(e, t, n) {
    ...
    var Sn = {
      ...
      "exif:ShutterSpeedValue": function (e) {
        return bn(nt.ShutterSpeedValue, e);
      },
    ...
    function Cn(e) {
      var t,
        n =
          ...
          (function (e) {
            if (e) {
              if ("string" == typeof e) return yn(e, 2);
              var t = {}.toString.call(e).slice(8, -1);
              return (
        ...
        (En = function (e) {
          ...
          function n() {
            return (function (e, t, n) {
              ...
              return n && xn(i, n.prototype), i;
            })(e, arguments, Tn(this).constructor);
          }
          return (
    ...
    var On = {
        read: function (e, t, n) {
          var r = {};
          if ("string" == typeof e) return Rn(r, e, n), r;
          var i,
            o =
              ((i = (function (e, t) {
                if (0 === t.length) return [];
                var n = [Fn(e, t.slice(0, 1))];
                return t.length > 1 && n.push(Fn(e, t.slice(1))), n;
              })(e, t)),
              (function (e) {
                if (Array.isArray(e)) return e;
              })(i) ||
          ...
          if (u) {
            var f = Rn(r, u, n);
            c || f || (delete r._raw, Rn(r, Fn(e, t), n));
          }
          return r;
        },
      },
          ...
          return (
            ...
            ((n = (function (e, t, n) {
              return (
                (t = Tn(t)),
                (function (e, t) {
                  if (t && ("object" == Pn(t) || "function" == typeof t))
                    return t;
                  if (void 0 !== t)
                    throw new TypeError(
                  ...
                  e,
                  wn()
                    ? Reflect.construct(t, n || [], Tn(e).constructor)
                    : t.apply(e, n),
                )
              );
    ...
    function Rn(e, t, n) {
      try {
        var r = (function (e, t) {
            ...
            var r = "string" == typeof e ? e : a(e, 0, e.byteLength);
            return {
              doc: kn(
                n,
                r
          ...
          i = r.doc,
          o = r.raw;
        return (e._raw = (e._raw || "") + o), l(e, _n(Nn(Dn(i), 1))), 1;
      } catch (e) {
        return 0;
      }
    }
    function kn(e, t) {
      ...
      try {
        ...
        if (i.length > 0) throw new Mn(i[0].textContent);
        return r;
      } catch (r) {
        if (
          "ParseError" === r.name &&
                ...
                i = (function (e) {
                  for (
                    var t,
                      n = [],
                      r =
                        /\b([A-Za-z_][A-Za-z0-9._-]*):[A-Za-z_][A-Za-z0-9._-]*\b/g;
                    null !== (t = r.exec(e));
                ...
                : (function (e, t, n) {
                    ...
                    (function (e) {
                      for (var t = [], n = 0; n < e.length; n++) {
                        var r = e[n],
                          i = Un[r] || "http://fallback.namespace/" + r;
                        t.push(" xmlns:" + r + '="' + i + '"');
                      }
                      return t.join("");
                    })(i),
    ...
    function Dn(e) {
      for (var t = 0; t < e.childNodes.length; t++) {
        if ("x:xmpmeta" === e.childNodes[t].tagName) return Dn(e.childNodes[t]);
            ...
            return (
              e.forEach(function (e) {
                if (
                  ...
                  var n = (function (e) {
                    return { attributes: Ln(e), value: Nn(e) };
                  })(e);
                  void 0 !== t[e.nodeName]
      ...
      for (var n in e) {
        ...
        Array.isArray(r) || (r = [r]),
          r.forEach(function (e) {
            l(t, Bn(e.attributes)),
              "object" === Pn(e.value) && l(t, Wn(e.value));
          });
      }
      return t;
    }
        ...
        try {
          Gn(n) &&
            (t[zn(n)] = {
              value: e[n],
              attributes: {},
              description: Vn(e[n], n),
            });
        } catch (e) {}
      return t;
    }
    function Gn(e) {
      return "rdf:parseType" !== e && !jn(e);
    }
    function jn(e) {
    ...
    function Vn(e) {
      ...
      if (Array.isArray(e)) {
        var n = (function (e) {
          return e
            .map(function (e) {
              return void 0 !== e.value ? Vn(e.value) : Vn(e);
            })
            .join(", ");
        })(e);
        return t && "function" == typeof Sn[t] ? Sn[t](e, n) : n;
      }
      if ("object" === Pn(e))
        return (function (e) {
          var t = [];
          for (var n in e)
            t.push("".concat(Hn(n), ": ").concat(Vn(e[n].value)));
          return t.join("; ");
        })(e);
      try {
        return t && "function" == typeof Sn[t]
          ? Sn[t](e)
          ...
          : Jn(e)
            ...
            : qn(e)
              ...
              : Zn(e)
                ? Qn(e, t)
                : (function (e) {
                      return void 0 !== er(e.value);
                    })(e)
                  ? (function (e, t) {
                      var n = er(e.value).value["rdf:li"],
                        r = Kn(e),
                        i = [];
                      return (
                        ...
                        { value: i, attributes: r, description: Vn(i, t) }
                      );
                    })(e, t)
                  : tr(e, t);
    }
        ...
        l(
          ...
          (function (e) {
            ...
            for (var n in e.value)
              "rdf:value" === n || jn(n) || (t[zn(n)] = e.value[n].value);
            return t;
          })(e),
        );
      var r = (function (e) {
        return nr(e.value["rdf:value"]) || e.value["rdf:value"].value;
      })(e);
      return { value: r, attributes: n, description: Vn(r, t) };
    }
    function Kn(e) {
      var t = {};
    ...
    function $n(e, t) {
      ...
      return (
        void 0 !== e.value["rdf:Description"] &&
          (l(n.value, Bn(e.value["rdf:Description"].attributes)),
          l(n.attributes, Kn(e)),
          (e = e.value["rdf:Description"])),
        l(n.value, Wn(e.value)),
        (n.description = Vn(n.value, t)),
        n
      );
    }
    function Zn(e) {
    ...
    function Qn(e, t) {
      var n = Bn(e.attributes);
      return { value: n, attributes: {}, description: Vn(n, t) };
    }
    function er(e) {
      return e["rdf:Bag"] || e["rdf:Seq"] || e["rdf:Alt"];
    }
    function tr(e, t) {
      var n = nr(e) || _n(e.value);
      return { value: n, attributes: Kn(e), description: Vn(n, t) };
    }
    function nr(e) {
    ...
    var ar = {
        2e3: {
          ...
          description: function (e) {
            for (var t = {}, n = [], r = 0; r < e.byteLength; r += 26) {
              var i = It.getShortAt(e, r);
              ur[i] &&
                (t[i] || (t[i] = ur[i].description),
                n.push({ type: i, path: ur[i].path(e, r + 2) }));
            }
      ...
      ur = ir(
          ...
          ir(
            ir(
              ir(
                ...
                4,
                { description: "Open subpath Bezier knot, linked", path: cr },
              ),
              5,
              { description: "Open subpath Bezier knot, unlinked", path: cr },
            ),
            6,
            {
        ...
        7,
        {
          ...
          path: function (e, t) {
            return [
              [sr(e, t, 8), sr(e, t + 4, 8), sr(e, t + 8, 8), sr(e, t + 12, 8)],
              sr(e, t + 16, 8),
            ];
          },
        },
    ...
    function cr(e, t) {
      for (var n = [], r = 0; r < 24; r += 8) n.push(fr(e, t + r));
      return n;
    }
    function fr(e, t) {
      var n = sr(e, t, 8);
    ...
    function sr(e, t, n) {
      ...
      return (
        ...
        (function (e) {
          return (
            parseInt(e.replace(".", ""), 2) /
            Math.pow(2, (e.split(".")[1] || "").length)
          );
        })(
          a.toString(2) +
            "." +
            (m("0", 32 - n - (r = u.toString(2)).length) + r),
        )
      );
    }
    function lr(e, t) {
    ...
    var dr = {
        read: function (e, t) {
          for (
            var n = o(new Uint8Array(e).buffer), r = {}, i = 0;
            i < e.length;

          ) {
            var u = a(n, i, vr);
            i += vr;
            var c = It.getShortAt(n, i),
              f = hr(n, (i += mr)),
              s = f.tagName;
            i += f.tagNameSize;
            var l = It.getLongAt(n, i);
            if (((i += gr), u === pr)) {
              var d = o(n.buffer, i, l),
                p = { id: c, value: a(d, 0, l) };
              if (ar[c]) {
                try {
                  p.description = ar[c].description(d);
                } catch (e) {
    ...
    function hr(e, t) {
      var n,
        r =
          ...
          (function (e) {
            if (e) {
              if ("string" == typeof e) return lr(e, 2);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                "Object" === t && e.constructor && (t = e.constructor.name),
                "Map" === t || "Set" === t
    ...
    var Ir = {
        read: function (e, t, n) {
          return n && t[0].compressionMethod !== g
            ? (function (e, t) {
                  ...
                  for (
                    var n = t.reduce(function (e, t) {
                      ...
                      a = function (e) {
                        ...
                        if (!n)
                          throw Error("ICC chunk ".concat(e, " not found"));
                    ...
                    a(u);
                  return Mr(new DataView(r.buffer));
                } catch (e) {
                  return {};
                }
              })(e, t);
      ...
      Tr = 12;
    function Or(e, t) {
      return e.length < t + Tr;
    }
    function Mr(e) {
      var t = e.buffer,
        n = e.getUint32();
      if (e.byteLength !== n) throw Error("ICC profile length not matching");
      if (e.length < Cr) throw Error("ICC profile too short");
      for (var r = {}, i = Object.keys(Sr), o = 0; o < i.length; o++) {
        var u = i[o],
          f = Sr[u],
          s = f.value(e, parseInt(u, 10)),
          l = s;
        f.description && (l = f.description(s)),
          (r[f.name] = { value: s, description: l });
      }
      if (Fr(t.slice(36, 40)) !== Pr)
        throw Error("ICC profile: missing signature");
      if (
        (function (e) {
          return e.length < Ur + 4;
        })(t)
      )
        return r;
      for (var d = e.getUint32(128), p = 132, m = 0; m < d; m++) {
        ...
        if (y === Ar) {
          ...
          if (1 === b) Rr(r, g, U[0].text);
          else {
            for (var O = {}, M = 0; M < U.length; M++)
              O["".concat(U[M].languageCode, "-").concat(U[M].countryCode)] =
                U[M].text;
            Rr(r, g, O);
          }
        } else
          y === wr
            ? Rr(r, g, Fr(t.slice(v + 8, v + h - 7)))
            : y === xr && Rr(r, g, Fr(t.slice(v + 8, v + 12)));
        p += 12;
      }
      return r;
    }
    ...
    function Rr(e, t, n) {
      yr[t]
        ? (e[yr[t].name] = { value: n, description: n })
        : (e[t] = { value: n, description: n });
    }
    var kr = {
        read: function (e, t, n, r, i) {
          var o = wt(e, vt, t, t + n, r, i);
          return (
            o.ShotInfo &&
              delete (o = l(
                {},
      ...
      Dr = { K3_III: 78420 },
      Nr = { CAMERA_ORIENTATION: 1, ROLL_ANGLE: 3, PITCH_ANGLE: 5 },
      Lr = {
        read: function (e, t, n, r) {
          var i = U(e, t + n + 8),
            o = t + n,
            a = wt(e, ht, o, o + 10, i, r);
          return (
            (function (e) {
              return (
                e.PentaxModelID &&
                e.PentaxModelID.value === Dr.K3_III &&
                e.LevelInfo
              );
            })(a) &&
              ((a = l(
                ...
                (function (e, t, n) {
                  ...
                  var i,
                    o = e.getInt8(t + Nr.CAMERA_ORIENTATION);
                  r.CameraOrientation = {
                    value: o,
                    description:
                      ((i = o),
                  ...
                  var a = e.getInt16(t + Nr.ROLL_ANGLE, n === C);
                  r.RollAngle = { value: a, description: _r(a) };
                  var u = e.getInt16(t + Nr.PITCH_ANGLE, n === C);
                  return (r.PitchAngle = { value: u, description: Br(u) }), r;
    ...
    var Kr = {
        read: function (e, t, n, r) {
          for (var i = {}, o = [], a = 0; a < t.length; a++) {
            var u = t[a],
              c = ii(e, u.offset, u.length, u.type, n);
              ...
              o.push(
                c.then(function (e) {
                  var t,
                    ...
                    u = e.description;
                  try {
                    if (h.USE_EXIF && si(o, a))
                      return { __exif: kt.read(di(a), ri, r).tags };
                    if (h.USE_IPTC && li(o, a))
                      return { __iptc: sn.read(di(a), 0, r) };
                    if (o && !si(o, a) && !li(o, a))
                      return (
                        (t = {}),
    ...
    function ii(e, t, n, r, i) {
      for (
        var o, a = [], u = [], c = [], f = qr, s = g, l = 0;
        l < n && t + l < e.byteLength;
        l++
      )
        if (f !== $r) {
          if (f === ei) {
          ...
          (s = oi({ type: r, dataView: e, offset: t + l })),
            r === Ae && (l += ti),
            (f = ai(r, f));
      if (s !== g && !i) return {};
      var p = v(
      ...
      return p instanceof Promise
        ? p
            ...
            .catch(function () {
              return ui("<text using unknown compression>".split(""), r, u, a);
            })
        : ui(p, r, u, a);
    }
    function oi(e) {
      var t = e.type,
        ...
        r = e.offset;
      if (t === Ae) {
        if (n.getUint8(r) === ni) return n.getUint8(r + 1);
      } else if (t === Ee) return n.getUint8(r);
      return g;
    }
    function ai(e, t) {
      return t === qr && [Ae, Ee].includes(e)
        ? $r
        : t === $r
          ? e === Ae
            ? Zr
    ...
    function ui(e, t, n, r) {
      ...
      return { name: ci(t, n, r), value: i, description: t === Ae ? fi(e) : i };
    }
    function ci(e, t, n) {
      var r = s(n);
    ...
    function di(e) {
      return (function (e) {
        for (
          var t = new DataView(new ArrayBuffer(e.length / 2)), n = 0;
          n < e.length;
          n += 2
        )
    ...
    var pi = {
      read: function (e, t) {
        for (var n = {}, r = 0; r < t.length; r++) {
          var i = It.getLongAt(e, t[r] + be),
            o = a(e, t[r] + Ie, Se);
          o === we
            ? ((n["Pixels Per Unit X"] = mi(e, t[r], i)),
              (n["Pixels Per Unit Y"] = gi(e, t[r], i)),
              (n["Pixel Units"] = vi(e, t[r], i)))
            : o === xe && (n["Modify Date"] = hi(e, t[r], i));
        }
        return n;
      },
    };
    function mi(e, t, n) {
      if (yi(e, t, n, 0, 4)) {
        var r = It.getLongAt(e, t + Ce + 0);
        return { value: r, description: "" + r };
      }
    }
    function gi(e, t, n) {
      if (yi(e, t, n, 4, 4)) {
        var r = It.getLongAt(e, t + Ce + 4);
        return { value: r, description: "" + r };
      }
    }
    function vi(e, t, n) {
      if (yi(e, t, n, 8, 1)) {
        var r = It.getByteAt(e, t + Ce + 8);
        return { value: r, description: 1 === r ? "meters" : "Unknown" };
      }
    }
    function hi(e, t, n) {
      if (yi(e, t, n, 0, 7)) {
        var r = It.getShortAt(e, t + Ce),
          i = It.getByteAt(e, t + Ce + 2),
          o = It.getByteAt(e, t + Ce + 3),
          a = It.getByteAt(e, t + Ce + 4),
          u = It.getByteAt(e, t + Ce + 5),
          c = It.getByteAt(e, t + Ce + 6);
        return {
          value: [r, i, o, a, u, c],
          description: ""
            .concat(Si(r, 4), "-")
    ...
    var bi = {
        read: function (e, t) {
          ...
          return (
            ...
            (n.ImageWidth = Ui(e, t + Ii)),
            (n.ImageHeight = Ui(e, t + Ci)),
            n
          );
        },
      },
    ...
    function Ui(e, t) {
      var n =
        It.getByteAt(e, t) +
        256 * It.getByteAt(e, t + 1) +
        65536 * It.getByteAt(e, t + 2) +
        1;
    ...
    var Pi = {
      read: function (e) {
        return {
          ...
          "Image Width": Ei(e),
          "Image Height": wi(e),
          "Global Color Map": xi(e),
          "Bits Per Pixel": Oi(e),
          "Color Resolution Depth": Ti(e),
        };
      },
    };
    function Ai(e) {
    ...
    function Ti(e) {
      if (!(11 > e.byteLength)) {
        ...
        return {
          value: t,
          description: "".concat(t, " ").concat(1 === t ? "bit" : "bits"),
        };
      }
    }
    function Oi(e) {
    ...
    var Mi = [6, 7, 99],
      Fi = {
        get: function (e, t, n) {
          if (
            (i = t) &&
            (void 0 === i.Compression || Mi.includes(i.Compression.value)) &&
      ...
      Ri = {
        get: function (e, t) {
          var n = {},
            r = 0,
            i = ki(e, "FocalLength", t),
            o = ki(e, "FocalLengthIn35mmFilm", t),
            a = (function (e, t) {
              if (e && t)
                try {
                  var n = t / (e[0] / e[1]);
    ...
    Di.prototype = Error();
    var Ni = { MetadataMissingError: Di },
      Li = { load: Bi, loadView: ji, errors: Ni },
      _i = Ni;
    function Bi(e) {
      var t,
                ...
                ? Promise.resolve(
                    (function (e) {
                      ...
                      if (-1 !== e.indexOf(";base64")) {
                        ...
                        return "undefined" != typeof Buffer.from
    ...
    function ji(e) {
      var t =
        ...
        p = {},
        m = [],
        g = et.parseAppMarkers(e, o),
        v = g.fileType,
        y = g.fileDataOffset,
        S = g.jfifDataOffset,
        I = g.tiffHeaderOffset,
        C = g.iptcDataOffset,
        U = g.xmpChunks,
        P = g.iccChunks,
        A = g.mpfDataOffset,
      ...
      if (
        ...
        var R = kt.read(e, I, u),
          ...
          D = R.byteOrder;
        if (
          (k.Thumbnail && ((p.Thumbnail = k.Thumbnail), delete k.Thumbnail),
          r
            ? ((p.exif = k),
              (function (e) {
                if (e.exif) {
            ...
            : (p = l({}, p, k)),
          h.USE_TIFF && h.USE_IPTC && k["IPTC-NAA"] && !zi(C))
        ) {
          var N = sn.read(k["IPTC-NAA"].value, 0, u);
          r ? (p.iptc = N) : (p = l({}, p, N));
        }
        if (h.USE_TIFF && h.USE_XMP && k.ApplicationNotes && !Vi(U)) {
          var L = On.read(s(k.ApplicationNotes.value), void 0, f);
          r ? (p.xmp = L) : (delete L._raw, (p = l({}, p, L)));
        }
        if (h.USE_PHOTOSHOP && k.ImageSourceData && k.PhotoshopSettings) {
          var _ = dr.read(k.PhotoshopSettings.value, u);
          r ? (p.photoshop = _) : (p = l({}, p, _));
        }
        if (h.USE_TIFF && h.USE_ICC && k.ICC_Profile && !Hi(P)) {
          var B = Ir.read(k.ICC_Profile.value, [
            {
              offset: 0,
              length: k.ICC_Profile.value.length,
              chunkNumber: 1,
              chunksTotal: 1,
            },
          ]);
        ...
        if (h.USE_MAKER_NOTES && k.MakerNote)
          if (
            (function (e) {
              return (
                e.Make &&
            ...
            var G = kr.read(e, I, k.MakerNote.__offset, D, u);
            r ? (p.makerNotes = G) : (p = l({}, p, G));
          } else if (
            (function (e) {
              return (
                e.MakerNote.value.length > 7 &&
                "PENTAX " === s(e.MakerNote.value.slice(0, 7)) &&
                e.MakerNote.__offset
              );
            })(k)
          ) {
            var j = Lr.read(e, I, k.MakerNote.__offset, u);
            r ? (p.makerNotes = j) : (p = l({}, p, j));
          }
        k.MakerNote && delete k.MakerNote.__offset;
      }
      if (h.USE_JPEG && h.USE_IPTC && zi(C)) {
        d = 1;
        var z = sn.read(e, C, u);
        r ? (p.iptc = z) : (p = l({}, p, z));
      }
      if (h.USE_XMP && Vi(U)) {
        d = 1;
        var V = On.read(e, U, f);
        r ? (p.xmp = V) : (delete V._raw, (p = l({}, p, V)));
      }
      if ((h.USE_JPEG || h.USE_WEBP) && h.USE_ICC && Hi(P)) {
        d = 1;
        var H = Ir.read(e, P, o);
        H instanceof Promise ? m.push(H.then(te)) : te(H);
      }
      if (
        h.USE_MPF &&
        (function (e) {
      ...
      if (h.USE_PNG && h.USE_PNG_FILE && void 0 !== E) {
        d = 1;
        var X = Gr.read(e, E);
        r
          ? ((p.png = p.png ? l({}, p.png, X) : X), (p.pngFile = X))
          : (p = l({}, p, X));
      }
      if (
        h.USE_PNG &&
      ...
      if (
        ...
        d = 1;
        var q = pi.read(e, x);
        r ? (p.png = p.png ? l({}, p.png, q) : q) : (p = l({}, p, q));
      }
      if (
        h.USE_WEBP &&
        (function (e) {
        ...
        d = 1;
        var $ = bi.read(e, T);
        r ? (p.riff = p.riff ? l({}, p.riff, $) : $) : (p = l({}, p, $));
      }
      if (
        h.USE_GIF &&
        (function (e) {
        ...
        d = 1;
        var Z = Pi.read(e, O);
        r ? (p.gif = p.gif ? l({}, p.gif, Z) : Z) : (p = l({}, p, Z));
      }
      var Q = Ri.get(p, r);
      Q && (r ? (p.composite = Q) : (p = l({}, p, Q)));
      var ee =
        (h.USE_JPEG || h.USE_WEBP) &&
        h.USE_EXIF &&
        h.USE_THUMBNAIL &&
        Fi.get(e, p.Thumbnail, I);
      if (
        (ee ? ((d = 1), (p.Thumbnail = ee)) : delete p.Thumbnail,
        v &&
          (r
            ? (p.file || (p.file = {}), (p.file.FileType = v))
            : (p.FileType = v),
          (d = 1)),
        !d)
      )
        throw new Ni.MetadataMissingError();
      return o
      ...
      function ne(e) {
        if (r) {
          for (var t = 0, n = ["exif", "iptc"]; t < n.length; t++) {
            var i = n[t],
              o = "__".concat(i);
            e[o] && ((p[i] = p[i] ? l({}, p.exif, e[o]) : e[o]), delete e[o]);
          }
          (p.png = p.png ? l({}, p.png, e) : e),
            (p.pngText = p.pngText ? l({}, p.png, e) : e);
        } else
          delete (p = l(
            {},
            p,
